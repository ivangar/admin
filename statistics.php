      ...
      <div class="navbar-wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="row"> 
                  <h1 class="page-header" style="margin-top: 0;"> Program Metrics (Per Year) </h1>
              </div>
        ...
        <script> 
            ...
            for (year = 0; year < results.length; year++) {
                //Insert in each program an array holding pretest results, and another with postest
                users[year] = [results[year][0], results[year][1], results[year][2]];
                
                if(typeof results[year][3] !== 'undefined' && results[year][3].length > 0){
                  programs[year] = results[year][3];
                }
            } 
        </script>
