...
include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/lib/evaluations.php');
...
if(!isset($_SESSION['result'])){
    ...
    $program_evaluations->Set_Results(); 
}
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                      <ul class="nav navbar-nav"> 
                          ...
                          <li class="active"><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/admin/program_evaluations.php">Program Evaluations</a></li>
                      ...
                      <ul class="nav navbar-nav navbar-right">
                       ...
                       <form class="navbar-form navbar-right" role="form" id='search_form' name='search_form' action='https://<?php echo $_SERVER['HTTP_HOST'] ?>/admin/lib/evaluations.php' method='post' accept-charset='UTF-8'>
          ...
          <div class="row">
              <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                  ...
                  <li class="active"><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/admin/program_evaluations.php"><i class="fa fa-table"></i>&nbsp; Program Evaluations</a></li>
              ...
              <div class="row">
                 <div class="col-sm-11 ">
                  <h1 class="page-header" style="margin-top: 0;"> Program Evaluations </h1>
                 </div>
                 <div class="col-sm-1 ">
                    <a href="#" class="btn btn-success export_eval" ><i class="fa fa-download fa-lg"></i>&nbsp; Export</a>
                  </div>
              </div>
              <?php if(isset($_SESSION['result']) && !isset($_SESSION['error'])){
                    ...
                    else{ echo $program_evaluations->Print_result(); } ?>
            </div>
          </div>
        </div>
        <ul>
