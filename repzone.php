<?php 
include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/lib/repzone_events.php');
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>DxLink Repzone Events</title>
    ...
    <body>
      ...
      <div class="navbar-wrapper">
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                      <ul class="nav navbar-nav">  
                          ...
                          <li class="active"><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/admin/repzone.php">Repzone</a></li>
                      </ul>
        ...
        <script src="js/repzone.js"></script>
